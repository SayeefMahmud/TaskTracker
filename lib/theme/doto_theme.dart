...
class DotoText {
  ...
  static TextStyle get screenTitle => GoogleFonts.inter(fontSize: 30, fontWeight: FontWeight.w600, letterSpacing: -0.9, height: 1.06);
  static TextStyle get sectionTitle => GoogleFonts.inter(fontSize: 26, fontWeight: FontWeight.w600, letterSpacing: -0.73, height: 1.15);
  static TextStyle get addTitle => GoogleFonts.inter(fontSize: 20, fontWeight: FontWeight.w600, letterSpacing: -0.5, height: 1.2);
  static TextStyle get cardTitle => GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w600, letterSpacing: -0.24, height: 1.35);
  static TextStyle get panelTitle => GoogleFonts.inter(fontSize: 14.5, fontWeight: FontWeight.w600, letterSpacing: -0.22, height: 1.3);
  static TextStyle get settingTitle => GoogleFonts.inter(fontSize: 15.5, fontWeight: FontWeight.w600, letterSpacing: -0.23, height: 1.3);
  static TextStyle get body => GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w400, height: 1.5);
  static TextStyle get eyebrow => GoogleFonts.inter(fontSize: 11, fontWeight: FontWeight.w600, letterSpacing: 0.88, height: 1.2);
  static TextStyle get fieldLabel => GoogleFonts.inter(fontSize: 10, fontWeight: FontWeight.w700, letterSpacing: 1.0, height: 1.2);
  static TextStyle get categoryLabel => GoogleFonts.inter(fontSize: 10.5, fontWeight: FontWeight.w700, letterSpacing: 0.74, height: 1.2);
  static TextStyle get priorityChip => GoogleFonts.inter(fontSize: 10.5, fontWeight: FontWeight.w700, letterSpacing: 0.63, height: 1.2);
  static TextStyle get navLabel => GoogleFonts.inter(fontSize: 12.5, fontWeight: FontWeight.w600, height: 1.2);
  static TextStyle get tabLabel => GoogleFonts.inter(fontSize: 13.5, fontWeight: FontWeight.w600, height: 1.2);

  static TextStyle get metaChip => GoogleFonts.jetBrainsMono(fontSize: 10.5, fontWeight: FontWeight.w400, height: 1.2, fontFeatures: _tabular);
  static TextStyle get counter => GoogleFonts.jetBrainsMono(fontSize: 11.5, fontWeight: FontWeight.w400, height: 1.2, fontFeatures: _tabular);
  static TextStyle get statNumber => GoogleFonts.jetBrainsMono(fontSize: 34, fontWeight: FontWeight.w700, letterSpacing: -0.68, height: 1.0, fontFeatures: _tabular);
  static TextStyle get rateNumber => GoogleFonts.jetBrainsMono(fontSize: 26, fontWeight: FontWeight.w700, height: 1.0, fontFeatures: _tabular);
}
          ...
          child: BackdropFilter(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: fill ?? c.glass,
                borderRadius: BorderRadius.circular(radius),
                border: customBorder ?? Border.all(color: c.edge, width: 1),
              ),
              child: child,
            ),
          ),
